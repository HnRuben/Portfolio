...
// ── JAVA SPRING ──────────────────────────────────────────────────
    ...
    // ── ANGULAR ───────────────────────────────────────────────────────
    {
      ...
      definition: `**Angular** est un framework frontend développé et proposé par Google, permettant aux développeurs de construire des applications web **Single Page Application (SPA)** en suivant des règles rendant l'application robuste et maintenable. Le framework est basé sur **TypeScript**, il nous impose une architecture structurée en composants, services et modules qui permet une bonne scalabilité et testabilité du code. **Angular** se distingue par sa rigueur : son typage fort, son injection de dépendances native, la gestion réactive des données avec **RxJS**, et un outillage **CLI** puissant. C'est aujourd'hui un des frameworks frontend les plus utilisés dans les entreprises, particulièrement dans le contexte d'applications métier complexes.`,
